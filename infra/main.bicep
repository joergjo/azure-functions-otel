...
resource eventHubRootManageSas 'Microsoft.EventHub/namespaces/authorizationRules@2024-01-01' existing = {
  parent: eventHubNamespace
...
resource functionApp 'Microsoft.Web/sites@2025-03-01' = {
  ...
  resource configAppSettings 'config' = {
    ...
    properties: {
        ...
        EventHubConnectionString: 'Endpoint=${eventHubNamespace.properties.serviceBusEndpoint};SharedAccessKeyName=${eventHubRootManageSas.name};SharedAccessKey=${eventHubRootManageSas.listKeys().primaryKey};EntityPath=${hubName}'
